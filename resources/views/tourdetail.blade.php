...
<div class="detail container mb-5 mt-4" style="width: 80%;">
    <div style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#" style="color: black; text-decoration: none">{{ $tour->province->province_name }}</a></li>
            ...
            {{-- <div class="d-flex flex"> --}}
                <div class="col">
                    ...
                    <div id="slide-wrapper">
                        ...
                        <div id="slider">
                            @foreach($tour->tour_places as $tp)
                                <img id="thumbnail" src="{{ asset('storage/images/'. $tp->place->place_image) }}" alt="" class="thumbnail active">
                            @endforeach
                        </div>
